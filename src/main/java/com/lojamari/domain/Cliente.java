...
public class Cliente implements Serializable {
	...
	/*
	 * @OneToMany(mappedBy="cliente", cascade = CascadeType.ALL) private
	 ...
	 * TipoCliente tipo) { super(); this.id = id; this.nome = nome; this.email =
	 * email; this.cpfOuCnpj = cpfOuCnpj; this.tipo = (tipo==null) ? null :
	 * tipo.getCod(); }
	 */
	 ...
	 */
	/*
	 * public TipoCliente getTipo() throws IllegalAccessException { return
